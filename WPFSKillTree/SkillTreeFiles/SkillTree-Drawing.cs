...
namespace POESKillTree.SkillTreeFiles
{
    public partial class SkillTree
    {
        ...
        HashSet<ushort> ChangedIDs = new HashSet<ushort> {720,
922,
1105,
1734,
2292,
...
48030};
        ...
        public void DrawHighlights()
        {
            ...
            {
                var pen = new Pen(new SolidColorBrush(Color.FromRgb(255, 255, 255)), 25);
                foreach (var pair in Skillnodes)
                {
                    if (ChangedIDs.Contains(pair.Key))
                    {
                        dc.DrawEllipse(null, pen, pair.Value.Position, 82, 82);
                    }
                }
